  ...
  public getProducts(): void {
    this.products = this.cachedProducts = [
      new Product(
        1,
        'Nike',
        'This is a description for Nike',
        250,
      ...
      new Product(
        2,
        'Adidas',
        'This is a description for Adidas',
        220,
      ...
      new Product(
        3,
        'Reebok',
        'This is a description for Reebok',
        280,
      ...
      new Product(
        5,
        'Hummel',
        'This is a description for Hummel',
        150,
        'https://logoeps.com/wp-content/uploads/2012/10/hummel-vector-logo.png'
      )
    ];
